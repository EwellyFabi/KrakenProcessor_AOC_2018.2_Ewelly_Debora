...
-- *****************************************************************************
-- Generated on "12/04/2018 08:56:39"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          ULA_16
-- 
...
ENTITY ULA_16_vhd_vec_tst IS
END ULA_16_vhd_vec_tst;
ARCHITECTURE ULA_16_arch OF ULA_16_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
...
-- negate
t_prcs_negate: PROCESS
BEGIN
	negate <= '1';
WAIT;
END PROCESS t_prcs_negate;
-- opcode[2]
